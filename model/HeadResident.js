...
class HeadResident {
    constructor(resident_id, fname, lname, contact_num, birthdate, address_line_1, address_line_2, barangay, country ,is_voter, is_pwd, medical_condition, status, remarks, date_created, created_by){
        this.resident_id = resident_id;
        this.fname = fname;
        this.lname = lname;
        this.contact_num = mainController.convertToInternationalFormat(contact_num);
        this.birthdate = mainController.convertDateToWorded(birthdate);
